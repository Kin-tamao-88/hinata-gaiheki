  ...
  return (
    <>
        ...
        <div className="mx-auto flex max-w-[1240px] items-center justify-between px-5 py-3 md:h-[112px] md:py-0 md:pl-10 md:pr-8">
          ...
          <div className="flex items-center gap-3 md:gap-6">
            <div className="hidden text-right md:block">
              <p className="text-[13px] text-gray-500">お電話でのお問い合わせはこちら</p>
              <a
              ...
              >
                <Phone className="h-4 w-4 flex-shrink-0 text-[#e8550a]" strokeWidth={2} />
                050-1882-4910
              </a>
              <p className="text-[13px] text-gray-500">受付時間 9:00〜18:00（日曜定休）</p>
            </div>
            ...
            <a
              ...
              className="flex h-11 items-center gap-2 rounded bg-[#06B037] px-5 text-[15px] font-bold text-white shadow-sm transition-colors hover:bg-[#059930] md:h-12 md:px-5 md:text-[16px]"
      ...
      <section className="relative overflow-hidden bg-cream">
        ...
        <div
          aria-hidden="true"
          className="absolute inset-0 bg-[linear-gradient(to_right,rgba(245,242,236,0.97)_0%,rgba(245,242,236,0.86)_52%,rgba(245,242,236,0.30)_100%)] md:hidden"
        />
        {/* テクスチャ（SP・PC 共通） */}
        <div
          aria-hidden="true"
            ...
            <div className="flex flex-col gap-2">
              {[
                ...
                <div key={item} className="flex items-center gap-2">
                  <CheckCircle2
                    className="h-4 w-4 flex-shrink-0 text-brandorange md:h-5 md:w-5"
                    strokeWidth={2}
                  />
